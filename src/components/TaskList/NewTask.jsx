const NewTask = () => {
    return (
        <div className="h-full w-75 bg-orange-900 rounded-2xl shrink-0 py-10 px-8 flex flex-col justify-between items-baseline-last">
            <div>
                ...
                <p className="text-[1rem] mt-2 text-white/95">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptatibus est sequi iste consequatur</p>
            </div>
