const TaskListNumbers = ({data}) => {
    return (
        <div className="flex gap-5 justify-between mt-10">
            <div className="w-[45%] rounded-xl bg-emerald-600 text-white py-6 px-9">
            ...
            <div className="w-[45%] rounded-xl bg-slate-700 text-white py-6 px-9">
                <h1 className="text-5xl font-bold">{data.taskNumbers.active}</h1>
                <h3 className="text-2xl font-medium mt-2">Accepted</h3>
            </div>
            <div className="w-[45%] rounded-xl bg-rose-900 text-white py-6 px-9">
